  ...
  return (
    <div className="flex items-center xl:h-full md:justify-center xl:justify-start">
      <div className="xl:h-fit xl:whitespace-nowrap ">
        ...
        <p className="mb-2 text-center text-3xl md:text-4xl font-semibold text-secondary xl:mb-4 xl:text-start xl:text-5xl 2xl:text-6xl">
          Feast Your Senses,
        </p>
        <p className="mb-2 text-center text-3xl md:text-4xl font-semibold text-primary xl:mb-0 xl:text-start xl:text-5xl 2xl:text-6xl">
          Fast and Fresh
        </p>
