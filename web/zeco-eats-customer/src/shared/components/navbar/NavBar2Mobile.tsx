...
export default function NavBar2Mobile({notHome}:{notHome:boolean}) {
  return (
    
      <>
        {" "}
        <div className={`2xl:hidden ${notHome && "sticky top-0 z-[1]"}`}>
        ...
        <div className="mx-sm mb-[1.5rem] mt-[1.5rem] flex justify-end text-sm md:mb-6 md:mt-6 xl:mx-lg 2xl:hidden">
